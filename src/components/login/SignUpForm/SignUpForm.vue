      ...
      <div class="login-register-form">
        ...
        <div class="row">
          <div class="col-sm-6 sin-login-register">
            ...
            />
            <div style="color:red">{{ form.duplicateEmail }}</div>
          </div>
          <div class="col-sm-6 sin-login-register">
            <BaseInput
              v-model="form.phoneNumber"
              :vuelidate="$v.form.phoneNumber"
              :label="$t('phoneNumber')"
              type="tel"
              autocomplete="phonenumber"
              data-test="signup-form-phoneNumber"
              maxlength="10"
            />
            <div style="color:red">{{ form.duplicatePhoneNumber }}</div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6 sin-login-register">
